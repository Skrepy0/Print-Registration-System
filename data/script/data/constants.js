...
export const state = {
  ...
  records: (JSON.parse(localStorage.getItem('printingRecords')) || []).map(
    ({ unitPrice, totalAmount, ...rest }) => rest
  ),
}
// DOM 元素
...
export const exportSelectedButton = document.getElementById(
  'export-selected-btn'
)
...
export const promptModalContent = document.getElementById(
...
export const closeEditTeacherData = document.getElementById(
  'close-edit-teacher-catch'
)
export const editCatchTBody = document.getElementById(
  'edit-catch-records-table-body'
)
export const editCatchSelectAll = document.getElementById(
  'edit-catch-select-all'
)
export const deleteSelectData = document.getElementById(
  'delect-selected-data-button'
)
...
export const closeAddDataModalButton =
...
export const backupSubmitterButton =
  document.getElementById('backup-data-button')
export const loadBackupSubmitterButton =
  document.getElementById('import-data-button')
export const uploadSubmitterFile = document.getElementById(
  'import-submitter-file'
)
// 计算字段 (印刷总数)
...
export const gradeOtherContainer = document.getElementById(
  'grade-other-container'
)
...
export const expenseTypeOtherContainer = document.getElementById(
  'expense-type-other-container'
)
export const expenseTypeOtherInput =
  document.getElementById('expense-type-other')
export const subjectSelect = document.getElementById('subject')
export const subjectOtherContainer = document.getElementById(
...
export const submitterOtherContainer = document.getElementById(
  'submitter-other-container'
)
export const submitterOtherInput = document.getElementById('submitter-other')
export const responsiblePersonInput =
...
export function reload() {
  if (window.selectData) {
    ...
    if (
      selectData.added_expense_type &&
      Array.isArray(selectData.added_expense_type)
    ) {
      const existingTexts = new Set(
        Array.from(expenseTypeSelect.options).map((opt) => opt.text)
      )
